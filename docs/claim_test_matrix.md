...
| 46 | C₃-op closed form $C_3^{op}=\sqrt{1-1/n_{max}}\to1^-$, envelope N≤2n_max−1 | `test_paper46_C3op_closed_form.py` (10/10; sup enumerated, limit, monotonicity) | pure sympy | BACKED-SOUND | the surviving content; strong-form Lorentzian convergence is DESCOPED (open) |
