...
\end{equation}
satisfies $\gamma_n \sim \frac{4}{\pi}\,\frac{\log n}{n}$ --- twice
the constant $2/\pi$ of the classical (probability-normalised) Fej\'er
first-moment estimate on the circle, here read as
$\mathrm{Vol}(S^2)/\pi^2 = 2\mathrm{Vol}(S^2)/\mathrm{Vol}(\mathrm{SU}(2))$
on the Hopf quotient $\mathrm{SU}(2)/U(1)$ (an observation; corrected
2026-09-02 from ``the same constant''). A Lipschitz comparison
...
Int. Math. Res. Not. \textbf{2025}, no.~13, rnaf197
(arXiv:2310.14733).
