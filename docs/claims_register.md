...
| 2 | Unit-S³ graph eigenvalues are −(n²−1); kinetic scale κ = −1/16 derived from the Fock projection (not fitted) | Paper 7 (κ + spectrum); Paper 0 (kinematic node labels only — disclaims the κ/spectrum derivation) | SYMBOLIC PROOF | same test files; κ derivation v2.26.1 |
