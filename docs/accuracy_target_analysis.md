...
| H2O | 19.4% | Level 4 angular basis at 6:1 charge asymmetry | Structural + basis | Lone pair coupling disabled (unphysical at Z_eff >= 6); charge-center origin helps but does not resolve the asymmetry |
