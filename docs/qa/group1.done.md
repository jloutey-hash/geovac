...
- 2026-09-05 -- **CERTIFIED status now STALE; re-cert owed.** The trunk DELTA #10 claim-impact reviewer (first run under the semantic-diff discipline) traced the Paper-38 Lemma-L5 withdrawal and the Lorentzian signature-blind descope through their group1 citers and found the owners were corrected but the citers/abstracts were not. Banked cluster (PI direction 2026-09-05: bank, do not fix now), fully enumerated in [`trunk.carryforward.md`](trunk.carryforward.md) **Part U.2**: **LARGE** -- group1 synthesis SS L5 (L695-710) credits the refuted L5 (B,P) assembly as 'completing the proof' and asserts the now-false height_P=0; P42 abstract (L136-141) and P43 abstract (L104-147 + STRONG_LORENTZ table L950-962) overstate the withdrawn finite-cutoff Lorentzian closure (bodies correctly signature-blind/descoped). **SMALL** -- systematic 'five lemmas ... L5 assembly' echo across P44/P42/P47/P51 (+ field guide); P40 L2258-62 cites the abandoned Pythagorean-route in future work; paper_43_..._outline.md L45. **Upgrade** -- synthesis k-fold L1526-40 (k=2 is constant 1, not the sqrt2 route). A focused group1 remediation pass is owed before group1 can be re-certified.
