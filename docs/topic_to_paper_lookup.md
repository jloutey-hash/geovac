...
| Derived SW conditioning law: cond(S)=(1+σmax)/(1−σmax) exact, 1−σmax=(kR)²π²/(24n²) (exponent exactly 2; fitted 1.85/1.97 pre-asymptotic); gerade constant 2/(1+min j₀)=2.555041; commutator = same spectrum, saturates at 1/2 | 60 | Paper 60 `sec:molecular` eq:sigma_law | Symbolic + Measured |
