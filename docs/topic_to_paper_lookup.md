...
| Seven-layer Coulomb/HO asymmetry (Paper 24 §V): (i) spectrum-computing L_0; (ii) calibration π; (iii) Wilson gauge with natural matter; (iv) modular-Hamiltonian wedge structure; (v) gravity termination; (vi) Mellin chirality-parity; (vii) CM Hodge structure of the compact flow (v4.103.0) | 24, 31, 56 | Paper 24 §V `subsec:asymmetry_layer4` (Sprint L2-F.1 Track 2, 2026-05-17); Paper 31 §sec:coulomb_ho cross-reference | Core |
...
| Three-center Slater electron-repulsion integral = an elliptic Bessel moment in momentum space (three phases, not three foci); transcendence jumps genus 0 → genus 1 at the third center | 59, 18, 34 | Paper 59 `sec:momentum`–`sec:reduction`; genus grading in Paper 18 §Level-2 and Paper 34 | Measured |
| Rank-4 Picard–Fuchs operator of the three-center integral is IRREDUCIBLE over ℂ(D) (Fourier–Laplace transform of an irreducible connection, Katz 1990; exact-integer monodromy witness) — so N(D) has no closed form via any factorization | 59 | Paper 59 `sec:obstruction` | Symbolic (theorem) + Measured |
| Three-center ERI period on the Legendre / Γ(2) modular family (λ=1−ρ exact); CM-fibre periods are Γ-values — a concrete elliptic cosmic-Galois period at the Q(i) CM point (same as the Dirac Kramers doublet) | 61, 56 | Paper 61 `sec:modular`; Paper 56 `rem:paper59_cm` | Observation |
| Integrated three-center observable = a Γ(2) multiple modular value (elliptic polylogarithm); explicit iterated-Eisenstein realization and the generic (non-CM) Hain–Brown locus remain open | 61, 59, 56 | Paper 61 `sec:modular`; Paper 59 `sec:scope`; Paper 56 `rem:paper59_cm` | Open |
| Thermal-time / KMS modular circle = the Hodge circle of the ℚ(i) CM point (J = β/4 point, μ₄ quarter-periods, spinor −1 at β/2); ℚ(i) seam with the T2 family CONVERGENT (spin-forced vs level-forced), not common-cause | 56, 59 | Paper 56 `rem:kms_hodge_circle`, `rem:paper59_cm` | Observation (exact backing) |
| T2 fibre = 2D Euclidean two-propagator correlator (Feynman parameters = Källén–Lehmann spectral masses; D = Euclidean-time displacement; j₀ = spatial box smearing); Stokes location = squared complexified Euclidean interval | 59, 61 | Paper 59 `sec:reduction` (kinematics); Paper 61 `sec:modular` (light cone / two-axis) | Measured |
| T2's modular home is X₀(2): the s↔t density exchange = ρ↦1/ρ = the T-coset; co-area fold = the involution; Γ₀(2)'s Z[i] elliptic point unphysical; physical fixed locus = pure-Tate cusp | 61, 56 | Paper 61 `sec:modular` (X₀(2) paragraph); Paper 56 `rem:paper59_cm` | Symbolic + Measured |
| Resurgent-skeleton pattern (5/5): Stokes data algebraic up to singularity-type-fixed π-power across E₁ seed / hybrid ERI / exchange class / N(D) / T2 cusp; integer charges + γ-as-bookkeeping in the exchange class; boundary period forced at weight ≤1, free at genus ≥1 | 61, 18, 34 | Paper 61 `sec:modular` [OBSERVATION] paragraph | Observation (5 objects) |
| SW conditioning law (= Kac-Murdock-Szegő asymptotic, c₁=π²; OURS is the identification of the metric as a finite section, not the law): cond(S)=(1+σmax)/(1−σmax) exact, 1−σmax=(kR)²π²/(24n²) (exponent exactly 2; fitted 1.85/1.97 pre-asymptotic); gerade constant 2/(1+min j₀)=2.555041; commutator = same spectrum, saturates at 1/2 | 60 | Paper 60 `sec:molecular` eq:sigma_law | Symbolic + Measured |
| The H₂ minimal-basis potential curve as ONE closed-form expression (2×2 singlet CI; atoms {exp,E₁,log,γ}); certified R_eq/D_e/force constant as roots of exact derivatives | 58 | Paper 58 `sec:qfd` eq:h2_pes | Symbolic + Measured |
| Quadrature-free diatomic: closed-form H₂ FCI to 84 digits (τ-series terminates symbolically; Sugiura 1927 corroboration) + LiH to 30 digits net of τ-tail bound; derived one-electron two-center closed forms | 58 | Paper 58 `sec:qfd` | Measured + Symbolic |
| T2 certified to 66 digits via the (k,w) factorization (double integral = square of a 1-D integral); β(2)/Catalan DECISIVE-NEG at h≤10 (64 digits) — no conductor-4 content in the physical value; closed form still open | 61, 56 | Paper 61 `sec:modular` eq:kw; Paper 56 `rem:paper59_cm` | Measured (decomposed certification) |
| Bargmann/S⁵ Hardy circle: no CM Hodge structure (Layer 7: positive generator, i^N rationality, discarded conjugate half) but conductor-4 periods transfer (Z₋(s)=2^{s−3}(β(s)−β(s−2)) = ¼ of P28) | 24, 56, 28 | Paper 24 `sec:asymmetry_layer4` Layer 7 + NON-layer | Measured (identity) / Observation (significance) |
