"""Pair-diagonal-m convention: m1=m3 and m2=m4 per pair."""
        ...
        for (l3, m3) in orbs:
            for (l4, m4) in orbs:
                ...
                for k in range(kmin, kmax + 1):
                    ...
                    if (l2 + l4 + k) % 2 != 0:
                        continue
                    # q1 = m1 - m3 = 0, q2 = m2 - m4 = 0
                    a1 = wigner_3j(l1, k, l3, -m1, 0, m3)
                    if a1 == 0:
                        continue
                    a2 = wigner_3j(l2, k, l4, -m2, 0, m4)
                    if a2 == 0:
                        continue
