"""Generate wilson_dirac_packing_test.py - Wilson-Dirac on the Dirac packing graph."""
import os

target = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'wilson_dirac_packing_test.py')
...
with open(target, 'w', encoding='utf-8') as f:
    f.write(code)
print(f"Written {len(code.splitlines())} lines to {target}")
