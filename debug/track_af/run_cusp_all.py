"""Track AF: 2D + l-dependent PK + cusp correction at l_max=2,3,4."""
import sys
...
for l_max in [2, 3, 4]:
    print(f"\n{'='*70}")
    print(f"Track AF: 2D + l-dependent PK + CUSP, l_max={l_max}")
    print(f"{'='*70}")
    ...
    fname = f"pes_2d_ldep_lmax{l_max}_cusp.txt"
