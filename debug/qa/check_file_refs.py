...
def main() -> int:
    ...
    # substring test this replaces is the mechanism behind the C19 bug: no
    # trunk paper's path contains "trunk", so a `--gate trunk` run silently
    # examined nothing and still printed PASS.
    if gate_corpus:
