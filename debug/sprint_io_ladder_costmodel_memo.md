...
Under test is the QC I/O thesis from the Coulomb-Sturmian literature: for a hyperspherical / Coulomb-Sturmian qubit
...
A note that strengthens that case: in the sparse-QROM baseline the table stores **both**
...
Because G is O(1) in L and S is (by that thesis) the small radial-seed count while L is the full
...
- **The LOAD-the-tensor baseline for chemistry.** Berry, Gidney, Motta, McClean, Babbush,
  *Qubitization of Arbitrary Basis Quantum Chemistry Leveraging Sparsity and Low Rank Factorization*,
  ...
  two-electron integrals** — i.e. loading a precomputed tensor. This is the object the "generate"
  competes against.
...
The structure of the first-quantized win maps one-to-one onto that decomposition:
...
**The generate-vs-load intuition is NOT novel as a principle — it is a known, exploited lever in
...
- **What (if anything) is specific to that framing.** The *general* lever is prior art. The
