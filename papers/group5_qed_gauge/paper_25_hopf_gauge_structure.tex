...
between~$0.082$ and~$0.185$, so \emph{no} single rescaling can leave
less than ${\approx}50\%$ maximum residual against the fit
(${\approx}33\%$ against the data) --- there is no uniform fit under
any convention.  (An earlier version quoted a $24.98\%$ residual from
an unrecorded fit convention; it is superseded by the pinned
computation in \texttt{tests/test\_su3\_wilson\_s5.py}, class
