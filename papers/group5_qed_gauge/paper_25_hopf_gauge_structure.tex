...
classes.  Under a node-local $U(1)$ gauge transformation
...
quotient spectrum to the $\mathbb{CP}^2$ sequence under a single
linear rescaling has a $24.98\%$ maximum relative residual; the
ratios $\lambda_{\text{quot},k} / \lambda_{\mathbb{CP}^2, k}$ range
between~$0.08$ and~$0.19$, with no uniform fit.  The quotient is a
...
\texttt{tests/test\_su3\_wilson\_s5.py} 39/39 pass)
