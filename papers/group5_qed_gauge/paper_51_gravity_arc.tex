...
Möbius asymptote is structurally locked, not a three-point coincidence.
\emph{Mechanism remains open} (task \#26 retraction stands, Fursaev--Miele 1996
\cite{fursaev_miele1996} contains no Möbius modification); three
sprint-scale closure routes are named (Fursaev--Miele \S III PDF read;
discrete mode decomposition; Sommerfeld contour at excess angle).
