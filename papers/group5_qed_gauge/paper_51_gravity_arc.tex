...
\begin{theorem}[Closed-form Seeley--DeWitt coefficients for scalar
                Laplacian on unit $\sthree$ --- SYMBOLIC PROOF;
                \texttt{tests/test\_paper51\_scalar\_ak.py}]
\label{thm:scalar_ak}
...
Dirac and scalar cones share the conical coefficient
$(1/12)(1/\alpha - \alpha)$, confirmed three independent ways --- by
...
\texttt{tests/test\_paper51\_g44\_headlines.py}.) This is the continuum Dowker~(1977)~\cite{dowker1977} /
Cheeger--Solodukhin~\cite{cheeger1983, solodukhin1995} spinor
...
see \S\ref{subsubsec:g4_5_v3_20_followon}, F14 closure).
\end{corollary}
...
is the robust gravity-sector finding; the exact coefficient and the
soft-IR ``mechanism'' are sweet-spot artifacts, and the continuum
mechanism remains open. A companion Reading-B test (Sprint GD-3) further
...
\textit{Phys.~Rev.~D}\ \textbf{109}, 124035 (2024),
arXiv:2404.11670.
