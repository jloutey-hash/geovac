...
2017 conically-deformed-sphere work likewise do not surface the
...
$\mathcal{T}_\alpha$ in the Latr\'emoli\`ere propinquity,
$\Lambda(\mathcal{T}_{n,\alpha},\mathcal{T}_\alpha)\le C_3\,\gamma_n\to0$, with
$C_3$ truncation-independent.
\end{lemma}
