...
\paragraph{Mechanism: Fursaev--Solodukhin spinor double-cover
correction.} At excess angle the Sommerfeld image-method contour
integral picks up additional poles that the standard analytic
continuation of the deficit-angle ($\alpha < 1$) Sommerfeld--Cheeger
formula misses. The discrete wedge-Dirac substrate computes the
proper excess-angle formula cleanly, not the simpler analytic
continuation. The literature reference is the spinor case treated
in~\cite{fursaev_solodukhin1995}.
