...
\begin{theorem}[$J$-blindness of $S^{(2)}$]
...
$t$-sweep. This is the continuum Dowker~(1977)~\cite{dowker1977} /
...
\begin{theorem}[Sector-wise Mellin moment map]
...
\begin{theorem}[L6: replica-weight-harmless convergence]
\label{thm:L6}
...
\S\ref{sec:BH_entropy} therefore comes from the spectral-action
