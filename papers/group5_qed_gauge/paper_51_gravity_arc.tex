...
$K_{\rm az}{=}64$); the lattice rate is $O(a^{1.1})$ (FD polar Laplacian at the
screened apex), with order-2 Richardson landing at $0.1643$ vs $1/6=0.1667$
($-1.4\%$, consistent with the G4-6b finite-$a$ offset). The joint rate is gated
by the lattice / Paper-47 norm-resolvent rate, \emph{not} degraded by the
replica weight.
