...
\paragraph{Relation to Papers 38, 40.} The propinquity convergence
...
the Latrémolière propinquity, with universal rate constant $4/\pi$. The
present paper's Rule B graph is a Dirac-spinor lift of the scalar Fock graph
on which Papers~38 and~40 work; a propinquity analysis of the Rule B Wilson
...
\bibitem{paper7}
GeoVac Project, ``The Dimensionless Vacuum: $S^3$ Conformal Equivalence and
18 Symbolic Proofs,'' Paper~7 (2025).
...
\bibitem{paper18}
GeoVac Project, ``Spectral-Geometric Exchange Constants,'' Paper~18 (2026).

\bibitem{paper24}
GeoVac Project, ``The Bargmann--Segal Lattice: $\pi$-Free Discretization of
the 3D Harmonic Oscillator on $S^5$,'' Paper~24 (2026).
...
\bibitem{paper35}
GeoVac Project, ``Time as Projection: Klein--Gordon, Matsubara, and the
Master Mellin Engine,'' Paper~35 (2026).

\bibitem{paper38}
GeoVac Project, ``SU(2) Propinquity Convergence on the Camporesi--Higuchi
Spectral Triple,'' Paper~38 (2026).

\bibitem{paper40}
GeoVac Project, ``Unified GH-Convergence on Compact Lie Groups: Universal
Rate Constant $4/\pi$ via Plancherel $\times$ Vandermonde Cancellation,''
Paper~40 (2026).
...
M.~Loan and C.~Hamer, ``Static quark potential and string tension for
