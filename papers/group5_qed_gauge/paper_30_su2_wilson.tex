...
Theorem~1's analog (Cartan reduction to $U(1)\times U(1)$) and
Theorem~2's analog (kinetic coefficient $1/12 = 1/(4 N_c)$) at machine
...
$1/8$ derived above is the $N_c = 2$ specialization.  The
$\mathrm{SU}(3)$ value $1/12$ is verified independently in
...
\texttt{tests/test\_su3\_wilson\_s5.py} 39/39 pass) tested a
...
$\mathrm{SU}(2)$ on $S^3$.  Three structural theorems mirror the
present results:
