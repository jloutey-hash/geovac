...
rows span $\ker L_1$ exactly); it is the co-exact part that completes
...
level.  All 33 tests in \texttt{tests/test\_su2\_wilson\_gauge.py}
pass.
...
All 33 tests in \texttt{tests/test\_su2\_wilson\_gauge.py} pass,
...
33 tests passing).  The present paper formalizes that construction
