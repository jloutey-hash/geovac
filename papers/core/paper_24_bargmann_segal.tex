...
refined to four layers across Sprint~5 Track~S5 (gauge-content),
Paper~30 (SU(2) Wilson on $S^3$), and Sprint~ST-SU3 (SU(3) Wilson on
$S^5$): (i)~spectrum-computing role of $L_0$
...
\item Layer~3: Wilson lattice gauge with natural matter coupling
  ...
  Sprint~ST-SU3).
\item Layer~4 \emph{(new)}: modular-Hamiltonian Pythagorean
