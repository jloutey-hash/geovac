...
\item \textit{Barut and Kleinert (1967)} \cite{barut1967}: The full conformal group $SO(4,2)$ acts as the dynamical symmetry group of hydrogen, connecting $S^3$ to the non-compact spectrum-generating algebra.
\end{itemize}
...
$\nu(\nu+4)/2 = 0, 3, 8, 15, \ldots$ have been verified numerically
