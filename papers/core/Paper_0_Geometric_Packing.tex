...
is the unique kinetic scale that maps the dimensionless graph
eigenvalues to the physical hydrogen spectrum, validated across
single-electron systems~\cite{companion_alpha}. This constant is not
independently derived from topology alone; it is the bridge between
the dimensionless graph and dimensionful physics, determined by
requiring spectral agreement with the Rydberg formula.
