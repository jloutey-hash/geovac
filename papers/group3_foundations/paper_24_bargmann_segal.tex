...
\item Layer~5 \emph{(new)}: spectral-action gravity termination
...
four-layer Coulomb/HO asymmetry is consistent across spectrum
computation, calibration, gauge-matter coupling, and modular
structure.
