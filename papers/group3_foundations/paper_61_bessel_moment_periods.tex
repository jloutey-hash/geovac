...
parameter integral sweeps the entire real locus of $X(2)$ and passes through
complex-multiplication fibres---at $\tau=i$ ($\rho=\tfrac12$, inside the
...
fibre theta series $K=\tfrac{\pi}{2}\theta_{3}^{2}$; guarded, decoy-calibrated
integer-relation searches place it inside the cosmic-Galois /
mixed-elliptic-motive layer the program's Tannakian substrate reaches for, and
are decisively negative for a clean low-height closed form through weight three.
...
concomitant---the Broadhurst--Mellit / Fres\'an--Sabbah--Yu quadratic period
relations for the $\Gamma(2)$ family---is identified in closed form as
$B=\pi\,\Omega$, with $\Omega$ the canonical integer symplectic intersection
form, forcing the differential Galois group into $\mathrm{Sp}_{4}(\mathbb{Z})$.
...
$B=\pi\,\Omega$ that forces the differential Galois group into
$\mathrm{Sp}_{4}(\mathbb{Z})$.
...
differential Galois group of the Picard--Fuchs equation of Paper~59 lies in the \emph{integral} symplectic
