...
Jacobian, the $\alpha$-combination $K = \pi(B + F -
...
(within the six-layer catalogue of Paper~24~\cite{paper24}), and gives
...
potential (the full asymmetry is catalogued as six layers in
...
six-layer asymmetry catalogued in Paper~24~\cite{paper24}.
...
asymmetry as six structural layers.
