...
combinations, applying the conditions of the definition above.  The
enumeration is implemented in
\texttt{geovac/nuclear/potential\_sparsity.py} as
\texttt{angular\_zero\_count}; $D_{\mathrm{pd}}$ matches
\texttt{debug/verify\_paper22\_lmax3.py} and both conventions are
reproduced by \texttt{debug/paper22\_m\_selection\_diagnostic.py}.}
