...
continuum $S^3$ in the Latr\'{e}moli\`{e}re
propinquity~\cite{paper38}, and the spectral action
...
\begin{equation}
  A = \sum_{(NLM)} \hat{M}_{NLM}^\dagger \otimes \hat{M}_{NLM}^\dagger
  \cdot [D_{\mathrm{total}}, \hat{M}_{NLM} \otimes \hat{M}_{NLM}],
  \label{eq:A_full}
\end{equation}
summing over all allowed multiplier labels in
$\mathcal{O}_{n_{\max}}$. The dagger pairing ensures $m$-conservation
(total magnetic quantum number $M_1 + M_2$ is preserved) and
Hermiticity of $A$.
...
\bibitem{paper7} J.~Loutey, ``The Dimensionless Vacuum: Fock
  Projection and the Graph Laplacian on $S^3$,'' GeoVac Paper~7
  (2025).

\bibitem{paper12} J.~Loutey, ``Algebraic $V_{ee}$: Neumann Expansion
  of the Electron--Electron Repulsion,'' GeoVac Paper~12 (2025).

\bibitem{paper14} J.~Loutey, ``Structurally Sparse Qubit
  Encodings,'' GeoVac Paper~14 (2025).

\bibitem{paper17} J.~Loutey, ``Composed Geometries for Molecular
  Systems,'' GeoVac Paper~17 (2025).

\bibitem{paper18} J.~Loutey, ``Spectral-Geometric Exchange
  Constants,'' GeoVac Paper~18 (2026).

\bibitem{paper22} J.~Loutey, ``The Angular Sparsity Theorem,'' GeoVac
  Paper~22 (2026).

\bibitem{paper31} J.~Loutey, ``The Universal/Coulomb Partition of the
  GeoVac Spectral Triple,'' GeoVac Paper~31 (2026).

\bibitem{paper32} J.~Loutey, ``The GeoVac Spectral Triple,'' GeoVac
  Paper~32 (2026).

\bibitem{paper34} J.~Loutey, ``The Projection Taxonomy: A Living
  Catalogue,'' GeoVac Paper~34 (2026).

\bibitem{paper38} J.~Loutey, ``Propinquity Convergence on $S^3$,''
  GeoVac Paper~38 (2026).

\bibitem{paper51} J.~Loutey, ``Spectral Action and Gravity on the
  GeoVac Lattice,'' GeoVac Paper~51 (2026).
