...
\end{equation}
attained at $\ell/n_{\max} \to 1 - 2/(2 + 2^{1/3}) = 0.386488$ (measured argmax $\ell = 11$ at $n_{\max} = 30$, $27$ at $70$).  The approach is monotone from below --- $C_{n} = 42.61$ at $n_{\max} = 320$, $42.70$ at $1000$, $42.73$ at $4000$ --- so every finite sample understates $C$, and the value printed here before 2026-09-03, $42.6$, was the $n_{\max} = 320$ sample rather than the limit (\texttt{tests/test\_paper1\_block\_spectrum.py}).  
