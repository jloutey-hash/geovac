...
\textbf{[OBSERVATION]} isospectral).  The present result is stronger in a specific sense:
...
coordination number, attained in a mid-$\ell$ block
...
\textbf{[MEASURED]} LiH, and BeH$^+$, with errors of $0.57\%$ for the hydrogen ground state on the
production graph at $n_{\max} = 30$ ($0.11\%$ at $n_{\max} = 70$; the
continuum chain itself is exact) and $5.3\%$ for the LiH equilibrium
