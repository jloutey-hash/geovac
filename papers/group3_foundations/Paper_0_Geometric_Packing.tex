...
\end{equation}
distinct angular slots.  The annular-area derivation of this $2k-1$
...
This spin-doubled vertex count is verified by
...
where an audit of 18~symbolic checks validates the conformal geometry
