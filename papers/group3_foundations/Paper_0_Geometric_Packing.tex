...
\end{equation}
and the deficit obeys $2 d_{\max} - \lambda_{\max} = (42.6 + o(1))/n_{\max}^2$ (log--log slope $-1.984$ over $n_{\max} = 20$--$320$; \texttt{tests/test\_paper1\_block\_spectrum.py}, added 2026-09-03).  
