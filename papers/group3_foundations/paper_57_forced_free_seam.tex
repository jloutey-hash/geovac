...
The Forced-Count Theorem~\cite{paper32} (Paper~32 \S VIII, \texttt{thm:forced\_count}) chains the standard real-spectral-triple axioms (Hermiticity, KO-dim-6 chirality, $J$-reality, order-one) into the bit-exact moduli dimension
\begin{equation}
  \dim_{\R} \Mcal(\DF) \;=\; 32 \quad (\text{one generation; matter-sector projection rank } 16),
