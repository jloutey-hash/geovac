...
The first four close the inner-factor structural-skeleton boundary at the canonical-rep level. The last two close the multi-focal-composition wall family. Remaining empirical-only catalogue entries (E6 combination rule $K$; D5--D6 CC fine-tuning; F4--F7 Higgs VEV / CKM / PMNS / neutrino masses; H6--H7 chemistry inner-factor data; I1--I3 foundational calibration) sit outside the two sectors now closed and are flagged for future upgrade if the C-arc continues.
