...
\paragraph{Sprint C-arc closure (E6 + D5/D6 + chemistry analog).} Two additional theorem-grade non-selection results and one named multi-month structural-research target were added in the C-arc terminal-state sprint (same day, 2026-06-08, v3.103.0), bringing the corpus to \emph{eight} theorem-grade non-selection results plus one named multi-month target:
