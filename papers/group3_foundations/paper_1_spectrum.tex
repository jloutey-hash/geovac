...
$\lambda_{2p} = 3.2306$ and a $1.73\%$ ratio (see the QA correction below,
...
digit printed.  \emph{At neighbouring cutoffs} the off-branch value is larger by a factor that \emph{grows without bound}, tracking $n_{\max}/(\sqrt{3}\,\pi)$ to within $1\%$:\ $6.6\times$ at $n_{\max} = 30$ ($1.65\%$ at $28$, $2.58\%$ at $29$ against $0.39\%$ at $30$), $23\times$ at $120$ and $552\times$ at $3000$.  (The
range ``three to six times'' printed here before 2026-09-04 was read off the
three cutoffs $28, 29, 30$ and stated as a theorem;\ the ratio is
$O(n_{\max})$, not bounded.)  \textbf{The endpoint quoted throughout
...
--- ``spectral aliasing\ldots\ standing-wave reflections that differentially
...
$3$, not by a boundary effect. This is a \emph{geometric boundary
effect},
