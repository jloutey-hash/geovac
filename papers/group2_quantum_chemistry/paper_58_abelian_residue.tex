...
rational two-center machinery (Mulliken--Roothaan auxiliary functions
...
rationals via the Mulliken--Roothaan auxiliary functions
$A_n$/$B_n$~\cite{mulliken1949,roothaan1951}, evaluated in prolate
