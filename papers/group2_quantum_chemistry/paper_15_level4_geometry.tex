...
7.2~pp at $l_{\max} = 6$.
This constant offset means $\pi$ convergence is independent of $\sigma$
...
At $l_{\max} = 4$, adding $\delta$ channels ($m_{\max} = 2$,
8~additional channels beyond the 29 $\sigma{+}\pi$ channels)
yields a modest $+0.65$~percentage-point gain (from 93.0\% to
...
Reaching $> 99\%$ would require higher $m$ channels ($m_{\max} \ge 2$)
...
$\pi$ channels contribute a constant ${\sim}6.6$~pp offset
