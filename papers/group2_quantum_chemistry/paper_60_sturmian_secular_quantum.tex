...
The cheap rule is also the one that stops converging---it saturates
...
of the deficit.  \textbf{The floor is $4.0\times$ chemical accuracy
...
growth, and is paid for by a $6.4$~mHa accuracy floor that no basis size in
...
question we leave.  \emph{For molecules}, the
