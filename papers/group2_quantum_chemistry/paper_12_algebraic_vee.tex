...
($R = 1.4632$) the same engine converges variationally to
$\gvq{p12_r12_heh_err_mha}{0.9}$~mHa of the reference at a modest basis,
and---consistently with the H$_2$ plateau
