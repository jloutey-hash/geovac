...
Eq.~\eqref{eq:r12_kinetic_collapse} above;\ chronicle in \texttt{CHANGELOG.md}.
(The prototype engine migrates from the sprint tree into \texttt{geovac/} when
the higher-power extension closes.)
