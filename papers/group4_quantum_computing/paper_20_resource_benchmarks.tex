...
\caption{Quantum resource comparison: GeoVac vs.\ Gaussian raw JW.
  ...
  resource study---is cited for the resource-estimation methodology only,
  not for the $Q^{3.9\text{--}4.3}$ Gaussian-scaling range or these specific
  electronic-structure counts, both of which are GeoVac's own recomputation).
...
\hline
LiH & 2 & 30 &  1\,413 & 333    &  29.97 &  121 & 0.113$\times$ \\
LiH & 3 & 84 & 89\,226 & 7\,878 & 204.93 & 11\,865 & 7.106$\times$ \\
BeH & 2 & 30 &  1\,413 & 333    &  40.26 &  111 & 0.113$\times$ \\
BeH & 3 & 84 & 89\,226 & 7\,878 & 278.51 & 11\,843 & 7.106$\times$ \\
...
\begin{itemize}
  ...
  \item The $\lambda_{\mathrm{ni}}$ column is non-inflated by
    ...
    favorable relative to Chawla et al.'s DC-UCCSD 1-norm (not reported
    in Chawla et al.'s main text).
