...
with frozen core).  At matched qubit count (not matched accuracy---the
composed H$_2$O carries a 26\% $R_{\rm eq}$ error), against cc-pVDZ
(46 qubits) GeoVac has $138\times$ fewer Pauli terms.
