...
Pauli count (334 vs.\ STO-3G's 276 reduced / 907 raw) while using more
qubits; the decisive resource advantages are the $O(Q^{2.5})$ Pauli scaling
and a 190$\times$ reduction versus cc-pVDZ.
...
for composed with PK.  The balanced 1-norm (306.4~Ha) is 18\% lower
than composed with PK in-Hamiltonian (373.4~Ha; the previously printed
354.9 came from the deprecated legacy BeH$_2$ builder path---the live
values are pinned by \texttt{tests/test\_paper20\_library.py}),
...
VQE default), the composed electronic-only 1-norm (66.0~Ha,
Table~\ref{tab:resources}) is far lower.

For H$_2$O ($Q=70$), FCI is infeasible (10 electrons), but the
Hamiltonian metrics are available: 5{,}798 Pauli terms, 1{,}511~Ha
...
\caption{Quantum resource comparison: GeoVac vs.\ Gaussian raw JW.
  ...
  the genuine advantage.  The \emph{2-qubit-reduced} Gaussian Pauli counts
  ...
  raw STO-3G LiH count (907, $Q=12$) used as the matched-raw market-test
...
\colrule
\multirow{5}{*}{LiH}
 & GeoVac composed & 30 & 334 & 32.6 & 21 & --- \\
...
\multirow{4}{*}{H$_2$O}
 ...
 & GeoVac balanced & 70 & 5{,}798 & 1{,}511 & 168 & --- \\
 & Gaussian STO-3G & 12 & 551 & --- & --- & $0.71\times$ Pauli \\
 & Gaussian cc-pVDZ & 46 & 107{,}382 & --- & --- & $138\times$ Pauli \\
\colrule
\multirow{2}{*}{BeH$_2$}
 & GeoVac composed & 50 & 556 & 66.0 & 21 & --- \\
 & GeoVac balanced & 50 & 2{,}652 & 306.4 & 138 & --- \\
\end{tabular}
\end{ruledtabular}
...
near parity with Gaussian STO-3G on Pauli count---334 terms vs.\ STO-3G's
276 (qubit-reduced) or 907 (raw JW), with a nearly identical electronic
1-norm (32.6 vs.\ 34.3~Ha)---while using more qubits (30 vs.\ 10--12).  The
favorable $2.7\times$/$13\times$ multipliers hold only against the
un-reduced raw-907 baseline and under the pair-diagonal ERI rule
...
gap widens decisively: $190\times$ fewer Pauli terms than cc-pVDZ.
...
H$_2$O carries a 26\% $R_{\rm eq}$ error), GeoVac has $138\times$
fewer Pauli terms.
The measured $O(Q^{2.2})$ vs.\ $O(Q^4)$ scaling implies that the GeoVac
...
MgH$_2$  & Ne   & 40 & 1{,}501 & 101.9 & 109 \\
HCl      & Ne   & 50 & 2{,}936 & 798.8 & 133 \\
H$_2$S   & Ne   & 60 & 4{,}119 & 816.9 & 141 \\
PH$_3$   & Ne   & 70 & 5{,}582 & 834.9 & 159 \\
SiH$_4$  & Ne   & 80 & 7{,}273 & 853.6 & 169 \\
\colrule
KH       & Ar   & 20 &    239 &  31.6 &  29 \\
CaH$_2$  & Ar   & 40 & 1{,}501 & 118.9 & 114 \\
HBr      & Ar$d$ & 50 & 2{,}936 & 809.4 & 132 \\
H$_2$Se  & Ar$d$ & 60 & 4{,}119 & 820.2 & 142 \\
AsH$_3$  & Ar$d$ & 70 & 5{,}582 & 824.2 & 159 \\
GeH$_4$  & Ar$d$ & 80 & 7{,}273 & 815.8 & 167 \\
\end{tabular}
\end{ruledtabular}
\end{table}
...
# 223, 171.46  (composed API: 222 non-identity + identity; FULL 1-norm
#  incl. the identity coefficient -- cf. the BALANCED Table row
#  (239 terms, lambda_ni = 18.9), a different builder and convention)
\end{lstlisting}
