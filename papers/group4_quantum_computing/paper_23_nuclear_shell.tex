...
Pauli terms, $1$-norm $\approx 342$~MeV) using the Minnesota
...
term count is $592$, with a $1$-norm of $\approx 342$ MeV dominated by
...
$\approx 467$ MeV (without Coulomb) and $\approx 462$ MeV (with
