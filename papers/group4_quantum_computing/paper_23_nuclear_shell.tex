...
\begin{enumerate}
  ...
  \item a magnetization-density inner-fluctuation
    ...
    the Eides Zemach correction~\cite{EidesGrotchShelyuto2007,Eides2024}
...
exponent $\lambda$, and
\texttt{\_radial\_split\_integral\_lam(lam\_a, n_1, l_1, lam\_b, n_2,
l_2, L, R)} computes the mismatched-exponent split-region radial
...
splitting~\cite{EidesGrotchShelyuto2007,Eides2024} is conventionally
...
\paragraph{Verification.}
At the Eides~2024 calibration $r_Z = 1.045$\,fm
...
Pachucki--Yerokhin~2010~\cite{PachuckiYerokhin2010}, QCD-internal NN
...
hydrogen,'' \emph{JHEP} \textbf{07} (2023), 211, arXiv:2306.13369.
[Replaces an earlier mis-attributed bibitem (PLB DOI
10.1016/j.physletb.2024.139049 resolved to an unrelated black-hole
paper); current entry is the best-match Eides--Shelyuto two-loop
QED reference; PI to verify intended source.]
...
HFS); current entry is the best-match Pachucki muonic-deuterium
reference; PI to verify intended source.]
