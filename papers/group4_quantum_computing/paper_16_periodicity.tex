...
universal result $\nu = N - 2$ and $\mufree = 2(N-2)(N-1)$.  This
...
\begin{enumerate}
  ...
  \item The Pauli centrifugal cost $\mufree = 2(N-2)(N-1)$ grows
...
\begin{enumerate}
  \item \textbf{The universal $\nu = N - 2$ result.}  Theorem~1 shows
    ...
    2(N-2)(N-1)$.  This specific identification appears to be new.
...
\begin{enumerate}
  \item \textbf{Per-electron scaling.}  $\mufree / N^2 = 2 - 6/N +
    4/N^2 \to 2$ as $N \to \infty$.
...
($S < N/2$).  $\nu = N-2$, $\mufree = 2(N-2)(N-1)$, and the asymptotic
...
While $\nu = N - 2$ and $\mufree = 2(N-2)(N-1)$ are universal, the
...
$\mufree = 144$.  Their chemistry differs only through the nuclear
...
\end{enumerate}
The SO$(3N)$ topology predicts no limit: $\mufree = 2(N-2)(N-1)$ is
...
in M.~Sch\"adel and D.~Shaughnessy (eds.),
\emph{The Chemistry of Superheavy Elements}, 2nd ed.\
