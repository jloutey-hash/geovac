...
(Lorentzian-propinquity-rate) closure remains the named open
frontier, beyond sprint scale.
...
Paper~40~\cite{paper40_unified}; a circle factor carries the circle constant). The five lemmas L1' / L2 / L3 / L4 /
...
in the Paper~38 state-space-GH rate constant
...
that the present paper builds on. The state-space GH rate constant
...
carries the circle constant), with the rate constant $4/\pi$ (rotation-angle normalisation of the $\SU(2)$ metric; $2/\pi$ on the unit round $S^3$, the constant scaling with the metric --- Paper~38, 2026-09-03)
