...
in the rotation-angle normalisation in which Paper~38 computes
$\gamma_\Lambda$, and $2/\pi$ on the unit round $S^3$; whether the
dual-Coxeter normalisation used here coincides with the former for every
$G$ in the class is a named check (2026-09-03). Paper~38
