...
metric, the constant identifies as twice the Haar-normalisation ratio
$\Vol(S^2)/\Vol(\SU(2)) = 2/\pi$; \textbf{[OBSERVATION]} the same ratio $2/\pi$ is the
...
\textbf{[OBSERVATION]} The $\SU(2)$ constant is twice the
circle constant, and both are of the form
$2\Vol(\text{base})/\Vol(\text{group})$:\ $2\Vol(S^0)/\Vol(S^1) = 2/\pi$
on the circle and $2\Vol(S^2)/\Vol(\SU(2)) = 4/\pi$ on $\SU(2)$. No
