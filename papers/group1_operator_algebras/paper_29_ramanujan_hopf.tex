...
closed-form factor $4s^2 + 1$ of Section~\ref{sec:closed_forms} has Ihara zeros
$\pm i/2$, algebraic but not algebraic integers; their reciprocals $\mp 2i$,
roots of the monic $s^2 + 4$, are the $T$-eigenvalues and \emph{are} algebraic
integers.)
