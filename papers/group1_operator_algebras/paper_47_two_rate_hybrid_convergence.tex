...
% the norm-resolvent / spectral level (§§3-4) AND at the propinquity /
% metric level on the natural substrate (§7, Theorem 7.3, via
% temporal-Lipschitz-invisibility zero-cost extent element).
%
...
%
% Honest scope: norm-resolvent at the outer arrow (§4), propinquity at
% the inner arrow (§3). Theorem 7.3 upgrades to propinquity-level on
% the natural substrate via the zero-cost extent element mechanism.
% Enlarged-substrate extension remains open (Q2).
% =====================================================================
...
Krein-lift (Paper~48~\cite{paper48}\,\S~3). This closes Q1
(G2-metric) on the natural substrate.
...
at the norm-resolvent level; Theorem~\ref{thm:g2_metric} upgrades
this to propinquity-level (hypertopology) convergence on the natural
substrate. The following open questions remain:

\begin{enumerate}
\item[(Q1)] \emph{G2-metric: CLOSED on the natural substrate}
...
\item[(Q2)] \emph{Enlarged-substrate non-compact extension: CLOSED
(flip-suppression).}
...
Theorem~\ref{thm:g3_closure}\footnote{Theorem~7.4 of Paper~32
...
J.~Loutey, ``The GeoVac spectral triple,''
