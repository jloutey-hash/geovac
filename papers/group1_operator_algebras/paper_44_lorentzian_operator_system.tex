...
template — Paper~38~\cite{paper38}'s Latrémolière-propinquity
...
$\sthree = \SU(2)$ at the qualitative-rate Latrémolière-propinquity
level; Paper~40~\cite{paper40_unified} closed it on the universal
...
\bibitem[Avery, Wen \& Avery(2002)]{avery_wen_avery2002}
J.~Avery, S.~Wen, and J.~Avery,
\newblock \emph{The 3-Y integral on the 3-sphere via Gegenbauer
recurrence},
\newblock J.~Math.~Chem. \textbf{32} (2002), 65--78.
