...
structurally impossible by tensor-product factorisation) --- the most
reachable of the three that remain is G1 (\S\ref{sec:unified_gauge}).
...
\emph{That open question} --- the almost-commutative lift of the
$\mathrm{SU}(2)_L$ Wilson instance, \emph{not} the chirality-grading
question Sprint~G3 closed --- is a clean $S^3$-only target that does not
require any progress on the $S^5$ side and that would, if successful, take
GeoVac from ``three Wilson-YM instances on three sub-manifolds''
to ``unified electroweak Wilson construction on $S^3$, plus a
separate $\mathrm{SU}(3)$ instance on $S^5$.''  (Clarified 2026-09-04:\
the 2026-09-03 correction inserted the G3-closure sentence above and left
this ``This'' pointing at the proven negative.)
...
direction (the almost-commutative lift of the $\mathrm{SU}(2)_L$ Wilson
instance on $S^3$ is the most concrete target;\ the chirality-grading
route to it is closed in the negative, \S\ref{sec:g3}).  Per the project's rhetoric rule, no claim is made that GeoVac
