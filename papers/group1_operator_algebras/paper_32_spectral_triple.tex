...
\begin{remark}[E6 scope and the conjectural-label discipline]
\label{rem:e6_scope}
...
Per CLAUDE.md \S 13.5, the conjectural label on the Paper 2 combination
rule is protected at the rule level and is preserved by this Theorem:\
