...
The L5 inequality (Lipschitz-normalised panel reach and height both
below $C_3\gamma_{n_{\max}}$) is verified numerically at $n_{\max} \in
\{2, 3, 4\}$ only --- the margin roughly halves per step and is not
claimed beyond those cutoffs (Paper~38, panel-scope note); the bound itself is $C_3\gamma_{n_{\max}} = 2.075, 1.610,
