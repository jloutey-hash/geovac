...
under an alternative rep --- remains the open multi-year structural-
...
multi-year structural-research targets;  Read~2 sharpest falsifier
...
exhibited;  the multi-year structural-research direction is named
...
multi-month NCG-research target.
...
Paper~57~\S 6.3 records this remark as the named multi-month
...
(Remark~\ref{rem:chemistry_eta_analog}) is the named multi-month
...
results across four sectors, one named multi-month follow-on (chemistry
