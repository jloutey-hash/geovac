...
a misnomer for Paper~38's $4/\pi$, which is a quotient of \emph{unit-radius}
sphere volumes and not a base-to-total ratio, corrected 2026-09-03)
...
$S^3$ Hopf base ($\mathrm{Vol}(S^2)/\pi^2 = 4/\pi$, the L2 state-space GH
