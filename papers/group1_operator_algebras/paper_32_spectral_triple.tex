...
\bibitem{paper51}
J.~Loutey, \emph{Gravity from the GeoVac spectral action:\ two-term
exactness on $S^3$, black-hole entropy, and the cutoff-sector Mellin
map} (Paper~51 of the GeoVac series, Zenodo, 2026).

\bibitem{paper54}
J.~Loutey, \emph{Two-body interactions from the tensor-product
spectral triple} (Paper~54 of the GeoVac series, Zenodo, 2026).
