...
Yukawa blocks to be colour-diagonal and colour-independent and kills
every lepton--quark and off-flavour entry.  The matter-sector projection
of the solution space has rank $16$ (pinned as a projection-rank check in
the same test module, 2026-09-03; the earlier statement that it spanned
the full $128$-dimensional matter space was the degenerate-sample
artefact recorded above).  Each constructed-triple
axiom-consistency check passes at
$n_{\max} \in \{2, 3\}$ in module
\texttt{geovac/standard\_model\_triple.py} (backed by
\texttt{tests/test\_standard\_model\_triple.py}, 45 tests).  \emph{QA
correction (2026-06-14):} those 45 tests verify the axiom consistency of
