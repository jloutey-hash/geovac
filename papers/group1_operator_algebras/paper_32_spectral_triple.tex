...
($-0.07$; measured 2026-09-03).  The panel is a fixed set
of low-degree harmonics rather than the unit-Lipschitz ball the lemma
quantifies over, so this neither confirms nor contradicts L5 (whose
proof does not use the panel);\ identifying the panel-side quantity is
an open check.  What the module reports is therefore the bound itself is $C_3\gamma_{n_{\max}} = 2.075, 1.610,
