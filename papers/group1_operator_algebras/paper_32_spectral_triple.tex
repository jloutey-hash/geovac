...
condition) carries, after the reductions $1024 \to 512$ (Hermiticity)
$\to 128$ (chirality grading) $\to 128$ ($J$-reality; order-one
imposes no further constraint), exactly $128$ real parameters. For
