...
unaffected by which representative of the equivalence class is taken;
...
\{2, 3, 4\}$; the bound itself is $C_3\gamma_{n_{\max}} = 2.075, 1.610,
...
$n_{\max} = 2$) are the GV factor's finite-resolution residual of
Table~\ref{tab:axiom_audit}, factorising through the operator-system
commutator with residual $0$ (\texttt{tests/test\_standard\_model\_triple.py});
...
matrices the matter-sector count is $128 \cdot N_{\mathrm{gen}}^2$.
\end{theorem}
