...
cutoff ($0.667$, $0.808$, $0.878$, $0.913$ at $n_{\max} = 2, 3, 4, 5$,
fitting $1.08 - 0.83/n_{\max}$) while $\gamma_{n_{\max}}$ falls, so it
exceeds the bound from $n_{\max} \approx 6$.  The panel is a fixed set
