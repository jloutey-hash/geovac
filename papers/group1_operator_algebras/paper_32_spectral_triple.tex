...
$4/\pi = \mathrm{Vol}(S^2)/\pi^2$ (rotation-angle normalisation; $2/\pi
= \mathrm{Vol}(S^2)/\mathrm{Vol}(\mathrm{SU}(2))$ on the unit $S^3$,
Paper~38, 2026-09-03).
...
rate $(4/\pi + o(1))\log n_{\max}/n_{\max}$ in the rotation-angle
