...
\texttt{papers/observations/track\_ni\_spectral\_triple\_zenodo.md},
...
\bibitem{Eides2024}
M.~I.~Eides,
``Hyperfine Splitting in Hydrogen and Polarizability of the Proton,''
Phys.~Lett.~B \textbf{(2024)}, doi:10.1016/j.physletb.2024.139049.
...
Systems,''
Phys.~Rev.~Lett.~\textbf{130}, 023004 (2023).
...
Phys.~Rev.~A \textbf{72}, 014501 (2005); deuteron Zemach radius
$r_Z(D) = 2.593(16)$~fm.

\bibitem{PachuckiYerokhin2010}
K.~Pachucki and V.~A.~Yerokhin,
``Theoretical hyperfine splitting in hydrogenic atoms with deuteron
nucleus,''
Phys.~Rev.~Lett.~\textbf{104}, 070403 (2010).
