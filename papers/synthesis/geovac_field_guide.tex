...
Three pieces of project-internal shorthand appear throughout.
Parenthetical designations of the form (Sprint Read~2, 2026-06-03)
are anchors into the project's internal chronicle
(\texttt{CHANGELOG.md} in the repository), where each investigation
--- a ``sprint,'' the project's unit of focused work --- is recorded
with its full evidence trail.  References of the form
CLAUDE.md~\S~1.7 point into the project's internal coordination file
(described at the end of this guide).  And ``wall'' is shorthand for
a structural obstruction established by multiple independent
negative results --- a documented boundary, not a conjecture of
difficulty.
...
application --- $O(Q^{2.5})$ composed Pauli scaling with a
...
of Paper~49 (whose OSLPLS strong-form bridge stands at the algebra level,
Q1$'$).  The repaired Lorentzian target --- a Toeplitz temporal
...
\begin{itemize}
  ...
  \item \textbf{$N_{\mathrm{gen}} = 3$}.  A deep structural
    obstruction;\ no sprint-scale line of attack is known
    (Sprint Read~2, 2026-06-03).
  ...
  \item \textbf{The M2/M3 motivic Galois unification (Q5')}.  Both M2 and
    ...
    (Sprint A7, 2026-06-03).  Deep frontier.
  \item \textbf{Deligne--Milne pro-finite reconstruction (TC-2 converse)}.
    ...
    frontier;\ each TC step (TC-1a..f, TC-2a..d) nonetheless closed
    at sprint scale at finite cutoff, suggesting the pro-finite
    assembly may do the same once the right transition-map machinery
    is in place.
...
\begin{itemize}
  ...
  \item \textbf{The physicist (gravity)}.  Read Paper~51.  Spectral
    ...
    $S_{\mathrm{BH}} = A/4$ replica derivation was closed by the L6
    sub-sprint (May~2026, replica-weight-harmless theorem).
