...
\end{equation}
with the constant $4/\pi$ (rotation-angle normalisation; $2/\pi$ on the
...
rotation-angle normalisation and $2/\pi = \mathrm{Vol}(S^2)/\mathrm{Vol}(\mathrm{SU}(2))$
on the unit $S^3$ --- the Hopf-base measure entering through a single
geometric mechanism, its value fixed by the metric normalisation, classified in
