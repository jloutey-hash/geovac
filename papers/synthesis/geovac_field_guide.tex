...
it (Papers~46, 48, 49), was retracted in June 2026;\ each paper carries
a Status note, and
...
\begin{itemize}
  \item \textbf{The mathematician (NCG, math.OA, spectral triples)}.
    ...
    proof);\ Paper~45 is the Lorentzian degeneracy theorem (an
    ...
    descope;\ Papers~46, 48, and 49 carry Status notes.
