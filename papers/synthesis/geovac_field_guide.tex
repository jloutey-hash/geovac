...
discrete spectral triple in the Marcolli--van Suijlekom graph-network
lineage, whose transcendentals classify as cyclotomic mixed-Tate
periods at level $\le 4$, and which separates --- through theorems,
...
\begin{quote}
\itshape
GeoVac is a discrete spectral triple in the lineage of
Marcolli--van Suijlekom 2014 gauge networks
\cite{marcolli_vs2014}, refined by the Perez-Sanchez 2024/2025
clarification that the continuum limit is Yang--Mills without Higgs
in general.
\end{quote}
...
\begin{itemize}
  \item \textbf{The mathematician (NCG, math.OA, spectral triples)}.
    Read Papers~38, 32, 47, 48, and 49.  Paper~38 is WH1 PROVEN;\
    Paper~32 is the explicit spectral triple construction with
    Connes axiom audit;\ Paper~47 closes the de-compactification
    limit at norm-resolvent level;\ Papers~48 and 49 are the
    Mondino--S\"amann bridge and the OSLPLS strong-form bridge.
  \item \textbf{The mathematician (periods, motives)}.
    Read Paper~55 (this corpus's most recent
    foundations paper).  Cyclotomic mixed-Tate classification at level
    $\le 4$, with explicit Glanois descent identification on the
    vertex-parity Mellin slot.  Open M2/M3 unification question
    (Q5') discussed in Paper~55~\S~7.6.
...
spectral triple in the Marcolli--van Suijlekom lineage, with
