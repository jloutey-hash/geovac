...
energies~\cite{loutey_paper60}.  Its $1$-norm grows more slowly than the
...
encode --- and at $K=452$ the ground state sits $4.28\times$ above chemical
accuracy while $2\,^{1}S$ sits $1.08\times$, the posing cost falling by
$4.3\times$, $3.0\times$ and $2.6\times$ across the first three rungs.  (Superseded 2026-09-07:\ the earlier $K^{0.84}$,
...
homonuclear-diatomic-like systems.  The $N$-electron $1$-norm question is answered in the
