...
arc---the ten Group~2 papers spanning one-electron atoms, the
two-center one-electron ion, the two-electron atom, the two-center
two-electron molecule, the core--valence and polyatomic
extensions, and the genuine two-center tensor census---into a single
...
missed by the counting.  The three genuinely cross classes---$80\%$ of
the tensor---remain \emph{counted} pending an independence argument over
their $\{E_1, \ln, \gamma\}$ seeds~\cite{loutey_paper58}.
...
two centers is the open polyatomic question.  Both remain named
