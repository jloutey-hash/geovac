...
for He, $99.81\%$ of $D_e$ ($0.32$~mHa, inside chemical accuracy) for
$\mathrm{H}_2$ in prolate spheroidal coordinates at the variational
optimum $\alpha = 1.40$---the fixed-$\alpha$ ladder endpoint is
$99.77\%$ ($0.41$~mHa)---and $96.0\%$ (cusp-corrected) in
...
4$^{\ast}$ & $\mathrm{H}_2$ (2, 2) & prolate spheroidal, $|m|\le1$ & $99.81\%$ of $D_e$ ($0.32$~mHa) at $\alpha_{\rm opt}=1.40$;\ $99.77\%$ at the fixed-$\alpha$ ladder endpoint & \cite{loutey_paper12} \\
...
variational optimum $\alpha = 1.40$~\cite{loutey_paper12}.  The
...
geometry is the prolate spheroid, where the re-conditioned CI reaches
$99.81\%$ ($0.32$~mHa)~\cite{loutey_paper12}---and composed fiber bundles for
