...
for He, ${\sim}99.1\%$ of $D_e$ for $\mathrm{H}_2$ in prolate
...
4$^{\ast}$ & $\mathrm{H}_2$ (2, 2) & prolate spheroidal, $|m|\le1$ & ${\sim}99.1\%$ of $D_e$ (envelope $99.0$--$99.1$) & \cite{loutey_paper12} \\
...
available from near-tripling the $\sigma$ basis~\cite{loutey_paper12}.  The
...
recurrence-based
(recurrence-stable and quadrature-seeded rather than fully
quadrature-free).
...
$0.26\%$ at $n_{\max}=5$ (grid-based) and $0.19\%$ at $n_{\max}=7$ with
...
coordinates for $\mathrm{H}_2$ ($96.0\%$, cusp-corrected;\ prolate
