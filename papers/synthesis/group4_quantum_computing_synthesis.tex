...
exponents in the $Q^{3.9}$--$Q^{4.3}$ range~\cite{trenev2025};\ the
specific electronic-structure values $Q^{4.25}$ (LiH) and $Q^{3.92}$
(H$_2$O) are GeoVac's own recomputation via the OpenFermion/Qiskit-Nature
pipeline applied in that baseline.
