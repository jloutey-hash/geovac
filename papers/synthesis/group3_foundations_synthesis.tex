...
program: \textbf{[SYMBOLIC PROOF]} (a) the discrete Fock graph's continuum limit is
conformally equivalent to the unit $S^3$ Laplace--Beltrami operator,
verified by a suite of 18 symbolic checks (ten of the eighteen limiting-case or
...
degeneracy recovery, not the operator convergence --- and the
...
degeneracy recovery through $n_{\max} = 30$ --- the latter now known to
