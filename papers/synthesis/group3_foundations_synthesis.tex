...
unconditionally with rate $(4/\pi)\log n_{\max}/n_{\max}$ (dual-Coxeter normalisation; $2/\pi$ on the unit $S^3$, $2\sqrt2/\pi$ under the field-standard Kac form)
...
$C/n_{\max}^2$, $C = 42.7397\ldots$ (Paper~0~\S VI) --- and the frozen
...
$F^0(\text{1s}, \text{1s}) = 5Z/8$, derived from the node-overlap
