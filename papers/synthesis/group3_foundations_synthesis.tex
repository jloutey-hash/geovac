...
Paper~56 closes the cosmic-Galois comparison $U^*_{\mathrm{GV}}
...
$1712\times$ advantage in Pauli-term count over published Gaussian
baselines.  The structural reason for this advantage is the
...
cutoff-sensitive, like the radial Pearson coefficient below).  Its angular structure is
...
\emph{The elliptic layer (Paper~59).}  The injection above lands in the
...
Paper~59 supplies a concrete elliptic period from the chemistry side:\ the
...
locus is open.  What the irreducibility \emph{does} certify is structural:\
...
Paper~56's cosmic-Galois injection lands in the mixed-Tate (genus-zero) group
