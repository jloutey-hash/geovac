...
\emph{The elliptic layer (Paper~59~\cite{loutey_paper59}).}  The injection above lands in the
...
Bessel moment on the Legendre / $\Gamma(2)$ family.  The load-bearing arithmetic
