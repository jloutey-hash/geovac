...
from Paper~22 --- the density the composed pipeline realizes (per-pair
$m_a=m_c$, $m_b=m_d$).  The physically-correct global-$M_L$ Coulomb
density $D(l_{\max})$ is $\sim\!4\times$ larger ($6.06\%$ at
$l_{\max}=3$; Paper~22 Table).  Both are universal across Coulomb,
