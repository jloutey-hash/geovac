...
sprint\footnote{Sprint/track designations are anchors into the
project's internal chronicle (\texttt{CHANGELOG.md} in the
repository); ``wall'' is project shorthand for a structural
obstruction established by multiple independent negative results.}
on the wedge KMS state of the framework's Lorentzian extension,
...
immersion --- the M3 column collapses to rank~1 under the
construction's per-sector period content, Reading~A; Paper~56)
...
(Paper~55), and the Tannakian injection (Paper~56) together place
theorem-grade boundaries around the empirical forced/free observation,
