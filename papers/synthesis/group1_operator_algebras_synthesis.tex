...
persist asymptotically (Paper~29~\S7).  Their Ihara zeta zeros are
algebraic integers with integer coefficients; no $\pi$ or transcendental
...
non-trivial Ihara zeros are algebraic integers; the corresponding Ihara
polynomials factor over $\Z[s]$ into integer-coefficient pieces, and
several factorizations admit explicit closed forms
