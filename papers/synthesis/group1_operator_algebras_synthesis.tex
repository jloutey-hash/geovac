...
The constant is that of the group $\SU(2)$, not of a circle:\ the
classical Fej\'er kernel on $\T^{1}$ has probability-normalised
first-moment constant $2/\pi$, half the $\SU(2)$ value (Paper~38,
Remark ``Connection to the circle Fej\'er estimate''; an earlier
statement that the two constants coincide is withdrawn, 2026-09-02).
