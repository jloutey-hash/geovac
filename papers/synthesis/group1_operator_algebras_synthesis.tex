...
\begin{abstract}
We provide a unified reading of the eleven papers that make up the
operator-algebra arc of the GeoVac framework
(Papers~29,~32,~38,~39,~40,~42,~43,~44,~45,~46,~47).  The arc constructs an
...
case-exhaustion theorem of Paper~32~\S\,VIII.  This synthesis gathers
the statements, sketches the load-bearing proofs, and exhibits the
structural relationships between the papers; no new theorems are
introduced.
\end{abstract}
