...
(Paper~43~\S 10.2 / Paper~46) settings, as the $M_{1}$ Hopf-base
...
single-KMS-state setting to multi-state stack consistency.  All four
properties (B1$'$)+(B2$'$)+(B3$'$)+(B4$'$) hold theorem-grade.
