...
$\Lambda$ bit-exact at all three panel cells (free-upgrade reading
extends to the OSLPLS bridge functor), max-divergence cocycle
deficits 66.998 / 68.720 / 81.256 nats positive and monotone-increasing
in $\nmax$, Riemannian-limit recovery at $\Nt = 1$ bit-exact.
