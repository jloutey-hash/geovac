...
the Klebanov--Pufu--Sachdev sphere F-theorem bit-exactly from the
...
The Bousso--Casini--Fisher--Maldacena 2020 ``kink transform'' / Connes
...
\bibitem[Bousso, Casini, Fisher \& Maldacena(2020)]{bousso_etal2020}
R.~Bousso, H.~Casini, Z.~Fisher, and J.~Maldacena,
\newblock \emph{Modular Hamiltonians on the null plane and the
Markov property of the vacuum state},
\newblock arXiv:2008.03319, 2020.
