...
selection $n_{\max} = 3$ gives $\kappa = -1/16$, the universal kinetic
scale of the GeoVac program~\cite{paper7}.
...
selects $n_{\max} = 3$ and connects to the universal kinetic scale
$\kappa = -1/16$.
...
A subsequent three-phase investigation of the universal kinetic scale
