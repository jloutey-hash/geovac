...
We extend the geometric vacuum framework to multi-electron systems by treating nuclear charge $Z$ not as a parameter, but as a \emph{conformal transformation} of the background metric. This reveals a deep connection between the vacuum kinetic scale $\mathcal{K} = -1/16$ and a universal topological torsion constant $\mu = 1/4$.
...
A profound duality emerges between the vacuum energy scale and the matter torsion. The universal kinetic scale of the vacuum, established in Paper~0 from the hydrogen spectrum alone, is:
\begin{equation}
