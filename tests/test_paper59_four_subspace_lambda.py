"""Backing test for Paper 59 sec:modular remark "The modulus is a four-point cross-ratio":
...
This places Paper 59's period in the classical four-singular-point / tame four-subspace (D~4)
...
def test_lambda_is_cross_ratio_of_branch_points():
    ...
    # Paper 59's Legendre lambda = 1 - rho is in the orbit ...
