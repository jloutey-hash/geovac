# RESTORED 2026-06-27 to geovac/_archive/superseded/ (importable per CLAUDE.md
# section 14). MolecularLatticeIndex + the cross-atom J/K, overlap, exact
# cross-nuclear, BSSE counterpoise, atomic-p0, and Fock-weighted kinetic
# correction machinery were DELIBERATELY removed from geovac/lattice_index.py
# in the v2.7.0 compaction (commit 8d692a0): this is the LCAO / graph-
# concatenation molecular-encoding arc, superseded by natural geometry and
# protected as the FCI-M guardrail (CLAUDE.md sections 3.5 / 14). It is
# restored here (NOT to production) so the Paper FCI-M headline numbers
# (LiH D_e^CP ~ 0.110 Ha, BSSE ~ 0.115 Ha, monotonic no-equilibrium PES)
# remain reproducible. Verbatim from 8d692a0^:geovac/lattice_index.py with
# 'from .' -> 'from geovac.' import-path fixes only.
"""
