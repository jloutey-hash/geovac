...
# Track I spectral-radial helper (restored 2026-06-27 from 8d692a0^; backs the
# Paper 15 spectral-radial 16x headline). The Level 3 Laguerre radial solver was
# deleted (not renamed) in the v2.7.0 compaction; it is resurrected in
# geovac/hyperspherical_radial.py and re-imported here.
...
def solve_direct_2d_spectral(
    ...
    pk_potentials : as in solve_direct_2d (core_potentials dropped to match current API).
...
def solve_level4_h2_multichannel(
    ...
    result['radial_method'] = radial_method
    result['angular_method'] = angular_method
    if radial_method == 'spectral':
