...
| Paper | File | Key Result |
|:------|:-----|:-----------|
| Paper 28 | `paper_28_qed_s3.tex` | QED on S³ (v2.0): 4 theorems + 1 proposition in theorem-proof format; self-energy structural zero; S_min at 200 digits irreducible (100-element PSLQ); three-loop O(N³) factorization; depth-k tower; comprehensive tables |
