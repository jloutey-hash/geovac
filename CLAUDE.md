...
**Version:** v5.13.1 (September 17, 2026)
...
- **V_ee z-recurrence + σ assembly validated (2026-09-17, v5.13.1):** #3 V_ee follow-on — first-kind Neumann moment A_l[a] float64-exact via the z-Laguerre l-recurrence (2e-16); σ-sector V_ee assembly machine-exact vs mpf (2.6e-15). Correct, not yet faster (mpf re-basing bottleneck); speed needs the A^prod recurrence + IBP-corr folding (next). See debug/sprint_direct_build_memo.md.
