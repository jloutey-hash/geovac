...
- **Corpus duration/register sweep COMPLETE (2026-07-05, v4.68.0):** ~228 wall-clock durations retired across 25 papers; C18 promoted to all-FAIL (0/0 over 59 papers); Q1′/Q2′ drift adjudicated vs Paper 49 (P49 closes Q1′, Q2′ only partial; memory corrected); PDF-tracking policy adopted + Notes.bib/generated-artifact tidy. See CHANGELOG v4.68.0.
- **Synthesis layer-discipline arc (2026-07-04/05, v4.67.8–.9):** three PI-directed register rules — withdrawal-chronicle → papers of record (rule 11), no project-course durations (rule 12 + C18 gate; 190-hit group-paper advisory debt), audience-register discipline (rule 13) — swept through all 7 syntheses; 2 genuine MATERIALs fixed (CvS-deferral attribution, 4/π tier); `/qa synthesis` post-cert delta = CLEAN (2/2 seeds, 4/4 controls) → cert stands with rules 11–13 verified. See CHANGELOG v4.67.8–.9.
