...
| Dirac-Coulomb radial ⟨r^{-2}⟩, ⟨r^{-3}⟩ (n_r>=1) | numerical-required | Kramers-Pasternak three-term recursion needed; raises NotImplementedError. (T7, deferred) |
