...
- **Synthesis layer-discipline pass (2026-07-04, v4.67.8):** withdrawal-chronicle → papers of record (rule 11) + no project-course durations (rule 12 + new C18 gate; 190-hit advisory debt named); seeded micro-delta 4/4 calibrated, 2 genuine MATERIALs fixed (CvS-deferral attribution, 4/π tier). See CHANGELOG v4.67.8.
