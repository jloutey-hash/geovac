...
- **`/qa` all-dimensions enforcement + run-#3 (2026-06-15, v4.16.2):** Gate now exercises all four review dimensions (code/claims/citation/synthesis) every invocation — unexercised gating dimension → INCONCLUSIVE, never PASS (closes the run-#2 short-circuit). First code+synthesis run found + fixed 2 real group3-synthesis defects (κ "derivable"→Observation, K "conjectural"→Observation ×4). See `qa.md`, `docs/qa/trunk.done.md`.
