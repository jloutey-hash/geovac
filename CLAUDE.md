...
| Paper 28 | On-topic | QED on S³ (v2.0): 4 theorems (T9, parity discriminant, χ_{-4} identity, self-energy structural zero) + depth-k tower proposition; S_min at 200 digits irreducible; three-loop O(N³) factorization |
...
| Paper 28 | `paper_28_qed_s3.tex` | QED on S³ (v2.0): 4 theorems + 1 proposition in theorem-proof format; self-energy structural zero; S_min at 200 digits irreducible (100-element PSLQ); three-loop O(N³) factorization; depth-k tower; c₂ = (2-BΔ-FΔ-F/B)/5 curvature coefficient bridging Paper 2; comprehensive tables |
