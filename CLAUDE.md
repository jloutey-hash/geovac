...
- **`/qa group2` re-cert#5 FAIL→remediated (2026-06-28, v4.50.4):** PERFECT calibration again (11/11, 6/6; rs8 4th catch) — **thin-residual asymptote**: 2 thin genuine residuals (P11 HeH⁺ secondary stale −1.475→−1.512 [recomputed]; P17 H2O 19.4%-correct but provenance-note cause wrong) + recurring synth −0.6025→−0.6026; NO DoD headline ever wrong across 5 runs. **PI cert-bar decision pending** (certify-at-bar / NIT-carve-out / run #6). See debug/qa/group2_recert5_run_notes.md.
